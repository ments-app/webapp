  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const res = await fetch(`/api/users/${encodeURIComponent(username)}/following${qs}`);
    ...
    <DashboardLayout>
      <div className="max-w-2xl mx-auto w-full px-3 sm:px-4 py-4">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground leading-tight">Following</h1>
            <p className="text-xs text-muted-foreground">People @{username} follows</p>
          </div>
        </div>
