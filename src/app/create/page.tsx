  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col mx-auto w-full max-w-6xl">
        {/* Header */}
        <div className="bg-[#0f1b15]/80 backdrop-blur-sm border-b border-[#1e2a24] px-4 md:px-8 py-3 flex items-center justify-start gap-3 flex-shrink-0 sticky top-0 md:static z-10">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg md:text-xl font-semibold text-white">Create Post</h1>
          </div>
        </div>
        ...
        <div className="flex-1 px-4 md:px-8 py-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-sm font-semibold text-gray-300 mb-2">Select Environment</h2>
